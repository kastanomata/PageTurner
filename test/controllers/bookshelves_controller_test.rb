...
class BookshelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookshelf" do
    assert_difference("Bookshelf.count") do
      post bookshelves_url, params: { bookshelf: { creator: @bookshelf.creator, name: @bookshelf.name } }
    end
  ...
  test "should update bookshelf" do
    patch bookshelf_url(@bookshelf), params: { bookshelf: { creator: @bookshelf.creator, name: @bookshelf.name } }
